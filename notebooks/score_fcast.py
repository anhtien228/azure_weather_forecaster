...
input_sample = pd.DataFrame({"dt": pd.Series(["2000-1-1"], dtype="datetime64[ns]"), "feels_like": pd.Series([0.0], dtype="float64"), "pressure": pd.Series([0], dtype="int64"), "humidity": pd.Series([0], dtype="int64"), "wind_speed": pd.Series([0.0], dtype="float64"), "clouds_all": pd.Series([0], dtype="int64"), "wind_x": pd.Series([0.0], dtype="float64"), "wind_y": pd.Series([0.0], dtype="float64")})
